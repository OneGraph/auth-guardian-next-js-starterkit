          ...
          execute: async (state) => {
            ...
            await fetchOneGraph(
              ...
              vercelOperationDoc,
              {
                ...
                value: state.vercelProject.link.org,
              },
              'CreateSecretMutation'
            )
            ...
            await fetchOneGraph(
              ...
              vercelOperationDoc,
              {
                ...
                value: state.vercelProject.link.repo,
              },
              'CreateSecretMutation'
            )
            ...
            await fetchOneGraph(
              ...
              vercelOperationDoc,
              {
                ...
                value: state.vercelProject.link.type,
              },
              'CreateSecretMutation'
            )
          ...
          <div className="card" style={{ flexGrow: '1' }}>
            <StepTriggerDeploy
              ...
              onLoggedIntoVercel={async () => {
                ...
                // hostname =
                //   'auth-guardian-next-js-starterkit-deployed-4-git-master.sgrove.now.sh'
    ...
    <>
      ...
      <main>
        ...
        <div className="h-screen w-screen bg-gray-200 absolute inset-0 z-0">
          <div className="w-screen inset-top bg-purple-900 bg-cover h-64 shadow-lg"></div>
        </div>
        <Container>
          <div className="text-gray-100 m-auto align-middle content-center items-center justify-center z-10">
            <div className="flex">
              {steps.map((step, idx) => {
                return (
                  <div
